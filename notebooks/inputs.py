...
__all__ = ['CoreInputSet', 'PinCellInputSet', 'AssemblyInputSet']


class CoreInputSet(object):
    def __init__(self):
    ...
    def build_default_settings(self):
        self.settings.batches = 200
        self.settings.inactive = 50
        self.settings.particles = 1000
        self.settings.source = openmc.Source(space=openmc.stats.Box(
...
class PinCellInputSet(object):
    ...
    def build_default_settings(self):
        self.settings.batches = 50
        self.settings.inactive = 10
        self.settings.particles = 1000
        self.settings.source = openmc.Source(space=openmc.stats.Box(
            [-0.63, -0.63, -1], [0.63, 0.63, 1], only_fissionable=True))
...
class AssemblyInputSet(object):
    ...
    def build_default_settings(self):
        ...
        self.settings.particles = 1000
        self.settings.source = openmc.Source(space=openmc.stats.Box(
            [-10.71, -10.71, -1], [10.71, 10.71, 1], only_fissionable=True))
